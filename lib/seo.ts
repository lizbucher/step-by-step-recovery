...
export function localBusinessSchema() {
  return {
    ...
    name: BRAND_NAME,
    legalName: "Step by Step TRC Holdings LLC",
    ...
    telephone: "+1-888-330-0312",
    faxNumber: "+1-314-828-6045",
    email: "hello@stepbysteprecoverystl.com",
    address: {
      "@type": "PostalAddress",
      streetAddress: "400 Chesterfield Center",
      addressLocality: "Chesterfield",
      addressRegion: "MO",
      postalCode: "63017",
      addressCountry: "US",
    },
    geo: { "@type": "GeoCoordinates", latitude: 38.6631, longitude: -90.5771 },
    areaServed: [
